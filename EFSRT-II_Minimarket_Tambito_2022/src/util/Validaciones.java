...
public class Validaciones {
	public static final String TEXTO = "[a-zA-Z·ÈÌÛ˙Ò¸¡…Õ”⁄—‹\\s]{2,20}";
	...
	public static final String TEXTO_NUMERO = "[0-9a-zA-Z·ÈÌÛ˙Ò¸¡…Õ”⁄—‹\\s]{2,40}";
	public static final String NUMERO = "[0-9]{1,1000}";
	public static final String SERIECRUDLIBRO = "[a-zA-Z·ÈÌÛ˙Ò¸¡…Õ”⁄—‹\\s]{2,100}";
	public static final String NUMEROSALA = "[A-Z]{1}[0-9]{2}";	
	public static final String PISO = "\\d{1}";
	public static final String NUM_ALUMNOS = "\\d{1,100}";
	public static final String NUM_SALA = "[A-Z]{1}\\d{2}";
}
